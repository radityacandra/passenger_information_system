...
<head>
  ...
  <title>Detail Evaluasi Pelayanan Kualitas Halte</title>
...
<!--container-->
<div class="col-md-10">
  <h2>Detail Evaluasi Pelayanan Halte</h2>
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">Koordinat Halte</div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body" style="height: 200px; overflow-y: auto;">
        <table class="table table-striped table-hover">
          <?php
          foreach($viewData['bus_stop_feedback']['feedback'] as $feedback){
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <h5>Rating Rata-rata (Dari <?php echo $viewData['bus_stop_feedback']['input'] ?> Responden)</h5>
        <h1><?php echo $viewData['bus_stop_feedback']['rating'] ?></h1>
...
<script>
  function initMap(){
    var busStopLocation = {
      lat: <?php echo $viewData['detail_bus_stop']['latitude'] ?>,
      lng: <?php echo $viewData['detail_bus_stop']['longitude'] ?>
    };
    ...
    var contentString = '<h4><?php echo $viewData['detail_bus_stop']['nama_halte'] ?></h4>'+
        '<h5><?php echo $viewData['detail_bus_stop']['lokasi_halte'] ?></h5>';
